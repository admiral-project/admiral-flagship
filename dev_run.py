...
NODES = [
    {
        ...
        "cpu": 8,
        "memory": 34359738368,
        "memory_used": 15032385536,
        "disk": 536870912000,
        "disk_used": 128849018880,
        "os": "Fedora 40",
        "podman_version": "5.0.0",
        "region": "us-east",
        "created_at": "2026-01-15T08:00:00Z",
        "updated_at": (NOW - timedelta(minutes=5)).isoformat() + "Z",
    },
    {
        "id": "n2",
        "hostname": "node-02.lan",
        "status": "online",
        "ip": "10.0.0.11",
        "cpu": 16,
        "memory": 68719476736,
        "memory_used": 30064771072,
        "disk": 1099511627776,
        "disk_used": 365072220160,
        "os": "Fedora 40",
        "podman_version": "5.0.0",
        "region": "us-east",
    ...
    },
    {
        ...
        "updated_at": (NOW - timedelta(hours=48)).isoformat() + "Z",
    },
    {
        "id": "n4",
        "hostname": "node-04.lan",
        "status": "online",
        "ip": "10.0.0.13",
        "cpu": 32,
        "memory": 137438953472,
        "memory_used": 60129542144,
        "disk": 2199023255552,
        "disk_used": 837518622720,
        "os": "Fedora 40",
        "podman_version": "5.0.0",
        "region": "us-west",
        "created_at": "2026-04-05T14:00:00Z",
        "updated_at": (NOW - timedelta(minutes=1)).isoformat() + "Z",
    },
]
    ...
    "app-whoami": [
        {
            ...
            "storage": 5368709120,
            "price_monthly": 9.99,
            "description": "For small experiments",
        },
        {
            "name": "business",
            "cpu": "2",
...
INSTANCES = [
    {
        ...
        "health": "healthy",
        "node_id": "n1",
        "url": "https://whoami.client1.admiral.bmogroup.solutions",
    ...
    },
    {
        ...
        "tier_id": "tier-business",
        "tier_name": "business",
        "customer_id": "client1",
        "status": "running",
        "health": "healthy",
        "node_id": "n2",
        "url": "https://blog.client1.admiral.bmogroup.solutions",
        "created_at": (NOW - timedelta(days=30)).isoformat() + "Z",
        "updated_at": (NOW - timedelta(hours=12)).isoformat() + "Z",
    },
    {
        "id": "i_i9j0k1l2",
        "app_id": "app-crm",
        ...
        "health": "degraded",
        "node_id": "n2",
        "url": "https://crm.client2.admiral.bmogroup.solutions",
    ...
    },
    {
        ...
        "health": "healthy",
        "node_id": "n4",
        "url": "https://n8n.client3.admiral.bmogroup.solutions",
        "created_at": (NOW - timedelta(days=10)).isoformat() + "Z",
        "updated_at": (NOW - timedelta(minutes=30)).isoformat() + "Z",
    },
    {
        "id": "i_q7r8s9t0",
        "app_id": "app-whoami",
        ...
        "health": "critical",
        "node_id": "n3",
        "url": "https://whoami.client4.admiral.bmogroup.solutions",
        "created_at": (NOW - timedelta(days=60)).isoformat() + "Z",
        "updated_at": (NOW - timedelta(days=7)).isoformat() + "Z",
    },
]
...
OPERATIONS = [
    ...
    {
        "id": "op_96",
        "type": "instance.deprovision",
        "status": "failed",
        "instance_id": "i_deprecated",
        "node_id": "n3",
        "created_at": (NOW - timedelta(days=5)).isoformat() + "Z",
        "updated_at": (NOW - timedelta(days=5)).isoformat() + "Z",
        "error_message": "node unreachable: connection timeout after 30s",
    },
]
...
def mock_admin_instance_inspect(instance_id):
    return (
        jsonify({"operation_id": "op_" + uuid.uuid4().hex[:12], "status": "queued"}),
        202,
    )
