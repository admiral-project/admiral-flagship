...
def test_proxy_fix_handling(app, client):
    ...
    with mock.patch.dict(os.environ, {"FLAGSHIP_PROXIES_COUNT": "1", "FLAGSHIP_ALLOWED_HEALTH_IPS": "1.1.1.1/32"}):
        ...
        resp = test_client.get('/flagship/api/health',
                               headers={'X-Forwarded-For': '1.1.1.1'},
                               environ_base={'REMOTE_ADDR': '10.0.0.1'}) # Proxy IP
